...
function New-Win32App {
    ...
    param (
        ...
        [Parameter(Mandatory = $false, ValueFromPipeline = $false, HelpMessage = 'Credential to use when connecting to the Site Server')]
    ...
    try {
        ...
        Write-Log -Message "An error occurred in the script" -LogId $LogId -Severity 3
